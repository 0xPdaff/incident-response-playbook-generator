# NIST SP 800-61 Rev. 3 — Incident Response Knowledge Base
...
This knowledge base contains the essential content from NIST SP 800-61r3, organized
for use by the Incident Response Playbook Generator. The LLM should reference this
knowledge base to ensure playbooks are consistent with NIST CSF 2.0 recommendations.
...
## 2. Incident Response Life Cycle & Roles
...
## 3. CSF 2.0 Community Profile — Part 1: Preparation & Lessons Learned (Table 2)
...
## 3. CSF 2.0 Community Profile — Part 2: Incident Response (Table 3)
